    ...
    $.getJSON(url, function (data) {
       ...
       // $("#software_version").append($("<option/>").text("--请选择 软件版本--").attr("value","-1"));
        ...
        $("#product_name").change(function () {
            ...
            $("#product_version").append($("<option/>").text("--请选择产品版本--").attr("value","-1"));
            //清除三级下拉列表
            $("#software_version").empty();
            $("#software_version").append($("<option/>").text("--请选择软件版本--").attr("value","-1"));
            $("#version_features").empty();
            $("#version_features").append($("<option/>").text("--请选择软件特性--").attr("value","-1"));
